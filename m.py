...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:-@itxx_abby."
...
def remove_user(message):
 ...
 Usage: /remove <userid>'''
        ...
        response = "Lund bhi nhi milta free me. AAJA MESSAGE KR @itxx_abby."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Lund bhi nhi milta free me. AAJ MESSAGE KR @itxx_abby."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            time = int(command[3])  #
            if time > 300:
                response = "Time interval must be less than 200."
            else:
...
Buy From :- @itxx_abby
Official Instagram :-  https://www.instagram.com/bgmi.pubg_dady?igsh=b2hvbnVrZXBicHR3
'''
...
def welcome_start(message):
    ...
    response = f'''AA GYA MERE SHER🦁. Bot Use Krna H Phale message Kr @itxx_abby.
BUY :- @itxx_abby'''
    bot.reply_to(message, response)
